...
**Goal:** Implement the spreadsheet-standard fill handle (drag-to-extend + `Ctrl+D`/`Ctrl+R`) for `DataGrid` grid-mode cell editing, per `docs/internal/superpowers/specs/2026-07-01-fill-handle-design.md`.
