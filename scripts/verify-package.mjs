...
const typeFixture = [
  'import type { DataGridServerAnalysisAdapter, GridColumnConfig } from "datagrizard";',
  "",
  ...
  '  id: "typed-consumer-adapter",',
  '  capabilities: { queryScopes: ["all", "filtered"], aggregateScopes: ["filtered"] },',
  ...
  "      rowCount: 0,",
  "      metrics: Object.fromEntries(request.input.metrics.map((metric) => [",
  ...
  "    };",
  "  },",
  "} satisfies DataGridServerAnalysisAdapter;",
  "",
  "void columns;",
  "void serverAnalysis;",
].join("\n");
